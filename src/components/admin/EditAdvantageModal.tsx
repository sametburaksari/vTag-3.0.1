...
interface EditAdvantageModalProps {
  advantage: Advantage;
  onClose: () => void;
}

export function EditAdvantageModal({ advantage, onClose }: EditAdvantageModalProps) {
  const [formData, setFormData] = useState({
    ...
    companies: advantage.companies || [],
    expiryDate: advantage.expiryDate || '',
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] flex flex-col">
        <div className="flex justify-between items-center p-4 border-b">
          <h3 className="text-lg font-semibold">Avantaj Düzenle</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    value={formData.type}
                    onChange={(e) => setFormData({ ...formData, type: e.target.value as 'link' | 'coupon' })}
                    className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  >
