...
const menuCategories = [
  ...
  },
  {
    title: 'Yönetim',
    items: [
      { path: '/admin/companies', icon: Building2, label: 'Firmalar' },
      { path: '/admin/users', icon: Users, label: 'Kullanıcılar' },
      { path: '/admin/profiles', icon: UserCircle, label: 'Profiller' },
      { path: '/admin/plans', icon: CreditCard, label: 'Abonelik Planları' },
    ]
  },
  {
    title: 'Özellikler',
    items: [
      { path: '/admin/advantages', icon: Gift, label: 'Avantajlar' },
      { path: '/admin/profile-details', icon: FileText, label: 'Profil Detayları' },
      { path: '/admin/domains', icon: Globe, label: 'Alan Adları' },
    ]
  },
  {
    title: 'Sistem',
    items: [
      ...
      { path: '/admin/logs', icon: History, label: 'Log Kayıtları' },
      { path: '/admin/settings', icon: Settings, label: 'Ayarlar' },
      { path: '/admin/support', icon: HelpCircle, label: 'Destek' },
    ]
  }
];
